...
const ROWS: { icon: keyof typeof ICONS; full?: boolean; text: ReactNode }[] = [
  {
    ...
    text: (
      <>
        <strong>גישה ל-37 שיעורים דיגיטליים קצרים, מושקעים וממוקדים</strong>, הזמינים לצפייה בקצב שלכם - כולל שתי
  ...
  {
    icon: 'compass',
    text: (<><strong>מנחה מלווה</strong> (בן אדם… כן כן) שילווה אתכם בצמתים שונים לאורך התהליך, יחשוב איתכם ויענה על כל שאלה וצורך.</>),
  },
  {
    icon: 'bot',
