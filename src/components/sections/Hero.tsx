      ...
      <div className="relative z-[2] grid w-full grid-cols-1 items-start gap-6 sm:pt-[8vh] md:grid-cols-[1.05fr_.95fr] md:gap-14">
        ...
        >
          <img
            ...
            alt="ד״ר אייל דורון"
            className="relative mx-auto block h-auto w-full max-w-[420px] md:absolute md:top-1/2 md:left-0 md:mx-0 md:w-[97.1%] md:max-w-[770px] md:translate-x-[20%] md:-translate-y-[40%]"
          />
        </div>
      </div>
    </section>
