    ...
    <section id="problem" className="px-[14px] py-5 sm:px-[clamp(16px,4.5vw,5em)] sm:py-[30px]">
      <div className="relative overflow-hidden rounded-[44px] border border-white/10 bg-dark px-5 py-14 text-center text-on-dark sm:px-[39px] sm:pt-[clamp(49px,6.2vw,83px)] sm:pb-[clamp(77px,9.7vw,124px)]">
        ...
        <div className="pointer-events-none absolute inset-0 z-0 opacity-50 sm:opacity-100">
          ...
          <Ghost className="top-[24%] left-[5%] -rotate-6 text-[clamp(33px,3.7vw,57px)] [-webkit-text-stroke:1.3px_rgba(255,255,255,.2)]">שינוי</Ghost>
          <Ghost className="bottom-[4%] left-[8%] text-[clamp(35px,4.1vw,62px)] [-webkit-text-stroke:1.3px_rgba(255,255,255,.22)]">עתיד</Ghost>
          <Ghost className="top-[44%] left-[2%] -rotate-90 text-[clamp(31px,3.3vw,51px)] [-webkit-text-stroke:1.3px_rgba(255,255,255,.19)]">קריירה</Ghost>
        ...
        <div className="relative z-[2] mx-auto flex max-w-[1000px] flex-col items-center gap-[26px]">
          <h2 data-reveal className="pt-[.12em] pb-[.18em] text-[44px] leading-[0.8em] font-bold text-white sm:text-[clamp(34px,5.6vw,68px)]">
            מרגישים שהעולם <br className="sm:hidden" />
            מתהפך במהירות?
          </h2>
          ...
          <p data-reveal className="max-w-[900px] text-[22.5px] leading-[1.2em] font-normal text-pretty text-on-dark sm:text-[clamp(20px,2.55vw,29px)]">
            כל מה שהזהירו אותנו מפניו קורה ונוצרה לנו שגרה חדשה: משבר רודף משבר. רודף מגפה. רודף מלחמה. בדרך ל... משבר
            הבא. יש המון שינויים ורעש מסביב ומה שברור הוא שאין לנו עוד זמן לבזבז. אז מה חייבים להבין? ואיך נשארים בלתי
            ניתנים-להחלפה בעולם שלא מפסיק לרוץ?
          </p>
          <p data-reveal className="max-w-[900px] text-[22.5px] leading-[1.2em] font-normal text-pretty text-on-dark sm:text-[clamp(20px,2.55vw,29px)]">
            דווקא בעידן של חוסר ודאות ושיבושים וברקע מהפכת ה-AI - הגיע הזמן לחשוב אחרת ויצירתית, לתכנן עתיד מפתיע
            ולא-לינארי, ולייצר לעצמנו ובסביבתנו: חיים של הפתעה עצמית.
          </p>
          <div data-reveal data-reveal-early className="mt-2">
            <Cta href="#price" className="px-[22px] py-3 text-[20.7px] sm:px-11 sm:py-4 sm:text-[21.3px]">
              הצטרפתי - אני בפנים!
            </Cta>
          </div>
        </div>
