...
const STEPS = [
  'נדייק ונייצר פוקוס ברמה אחרת לגמרי',
  'נגדיר את ״המטרה הגדולה״ לשנים הקרובות - באופן מקורי, אישי, מלהיב ומדויק',
  'נגדיר את ״הקווים האדומים״ שלנו, ולצידם את הערכים המובילים ואת האג׳נדה האישית',
  'נרכיב את ״מפת הקשרים״ החדשה שלנו - נזהה ונמפה את ״משלימי הגאונות״ ו״בורד היועצים״, ונקבל כלים לטיפוח קשרים חלשים ולבניית הלהקה שלנו בעולם',
  'נלמד להתיידד עם חוסר ודאות, לאהוב שינויים ולהתמודד עם המכשולים הפנימיים והחיצוניים שבדרך',
  'נבנה תוכנית פעולה מעשית ויצירתית, המשלבת אסטרטגיה ייחודית וטקטיקה מקורית למימוש המטרות הגדולות שלנו',
]
      ...
      <div className="relative overflow-hidden rounded-[44px] border border-white/10 bg-dark px-[14px] pt-[46px] pb-9 text-on-dark sm:px-7 sm:pt-14 sm:pb-20">
        ...
        <div className="relative z-[2] w-full">
          ...
          <div data-reveal data-reveal-early className="-mt-[15px] text-center sm:mt-9">
            <Cta href="#contact" className="px-[22px] py-3 text-[20.7px] sm:px-10 sm:py-[15px] sm:text-[21.3px]">
              אני רוצה לצאת לדרך!
            </Cta>
          </div>
        </div>
