      ...
      <div className="relative z-[1] grid w-full grid-cols-1 items-center gap-14 md:grid-cols-[1fr_1.1fr]">
        ...
        <div data-reveal className="relative z-[30] mr-0 text-center sm:mr-[clamp(60px,9vw,180px)] sm:text-right">
          ...
          <p className="text-[22.5px] leading-[1.2em] text-pretty text-ink-black sm:text-[clamp(20px,2.55vw,29px)]">
            ראש תוכנית Creativity in Action באוניברסיטת רייכמן, <br className="hidden sm:inline" />
            חוקר ומומחה לאסטרטגיה יצירתית ולניהול בעולם חסר ודאות.
          </p>
          <p className="mt-4 text-[22.5px] leading-[1.2em] text-pretty text-ink-black sm:text-[clamp(20px,2.55vw,29px)]">
            ד״ר דורון עובד באופן שוטף עם מנהלים וארגונים <br className="hidden sm:inline" />
            ומוביל תהליכים מורכבים ומשני מציאות בארץ ובעולם. <br className="hidden sm:inline" />
            מחבר רב-המכר ״יש ממי ללמוד: 8 שיעורים משני חיים״.
          </p>
        </div>
      </div>
    </section>
