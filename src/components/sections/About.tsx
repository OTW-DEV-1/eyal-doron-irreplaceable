  ...
  return (
    <section id="about" className="relative overflow-hidden px-[18px] py-[50px] sm:py-10 sm:pr-0 sm:pl-[clamp(18px,6vw,8em)]">
      ...
      <div className="relative z-[1] grid w-full grid-cols-1 items-center gap-14 md:grid-cols-[1fr_1.1fr]">
        ...
        >
          <img
            src={asset('eyal-about-new2.webp')}
            alt="ד״ר אייל דורון"
            className="static mx-auto block h-auto w-full max-w-[440px] sm:absolute sm:right-10 sm:bottom-0 sm:mx-0 sm:h-full sm:w-auto sm:max-w-none sm:-translate-x-[25%] sm:object-contain sm:object-bottom"
          />
        </div>
        <div data-reveal className="relative z-[30] mr-0 text-center sm:mr-[clamp(20px,4.5vw,90px)] sm:ml-[clamp(40px,4.5vw,90px)] sm:text-right">
          ...
          <p className="text-b2c mb-6 text-[30px] leading-[1.1em] font-semibold sm:text-[clamp(25px,2.75vw,33.8px)] sm:leading-normal">
